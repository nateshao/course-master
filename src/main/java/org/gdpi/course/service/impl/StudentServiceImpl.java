...
public class StudentServiceImpl implements StudentService {
    ...
    @Override
    public List<Course> personalizedCourse(Integer id) {
        return studentMapper.personalizedCourse(id);
    }

    @Override
    public List<Course> personalizedAllCourse() {
        return studentMapper.personalizedAllCourse();
    }
